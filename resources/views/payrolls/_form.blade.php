<div class="row mt-sm-4">
    <div class="col-12 col-md-12 col-lg-5">
        <div class="card profile-widget">
            ...
            value="{{ $payroll->worker->type_worker->id }}">

            <input id="sub_type_worker_id" type="hidden"            
            value="{{ $payroll->worker->sub_type_worker->id }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                            ...
                            @if ($eps_type_law_deduction)
                                <tr id="eps_type_law_deduction-{!! $eps_type_law_deduction['id'] !!}">
                                    ...
                                    <td><a href="javascript:eliminar_deduccion({!! $eps_type_law_deduction['id'] !!}, 'Na', {!! $eps_type_law_deduction['value'] !!})"
                                            class="btn btn-icon disabled btn-sm btn-danger"><i class="fas fa-times"></i></a>
                                    </td>
                                </tr>
                            @endif
                    ...
                    <input id="concepts_parafiscal" type="hidden" value="{{ $payroll->company->concepts_parafiscal_contributions }}">
